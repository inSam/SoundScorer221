...
We will extract more features from the spotify database such as artist popularity, age, location, audio sections, and signature. We will also try to construct more advanced features from historical data such as musical trends. This step will involve a lot more feature tuning and experimentation.
...
\section{Challenges}
One challenge is to consider the effects of time on the popularity on the song. We may be ble to tackle this by simply adding the age of the song as a additional feature.  
