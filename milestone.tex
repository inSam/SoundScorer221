...
\section{Methods}
\subsection{Dataset}
Our dataset comprises songs extracted from the Spotify API, which provides acoustic features, author information, and song metadata. More abstract features were pulled from The Echo Nest's API, which is incororated into the Spotify API.
\subsection{Feature Selection}
\subsubsection{Baseline Features}
We begin with seven audio features extracted by The Echo Nest. These seven features are "acousticness", "danceability", "energy", "loudness", "speechiness", "tempo", "valence". These audio features are extracted directly from the audio files of each song. Unfortunately, The Echo Nest's algorithms are propietary, and we are unable to access how they extracted these features.
