...
Worth noting in our linear regression classifier are the coefficient weights, which provide a crude approximation for the importance of each factor. The factor most strongly predictive of popularity is 'danceability', with a weight of $20.70$. The factor most strongly predictive of unpopularity is 'valence', with a weight of $-9.24$.
